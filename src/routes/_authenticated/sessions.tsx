...
function SessionsPage() {
  ...
  const [form, setForm] = useState({ course_id: "", title: "", grace_minutes: 15 });
  ...
  const create = async () => {
    ...
    setOpen(false);
    setForm({ course_id: "", title: "", grace_minutes: 15 });
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent>
            ...
            <div className="space-y-3">
              ...
              <div><Label>Grace period (minutes)</Label><Input type="number" value={form.grace_minutes} onChange={(e) => setForm({ ...form, grace_minutes: Number(e.target.value) })} /></div>
