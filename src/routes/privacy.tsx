    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-3xl mx-auto px-6 py-10 prose prose-sm md:prose-base">
        ...
        <ul className="list-disc pl-6 space-y-1">
          <li><b>Lecturer accounts:</b> full name and email address (from Google Sign-In or email/password registration).</li>
          <li><b>Student records (uploaded by the lecturer):</b> full name, index number, level, department/programme, email address, and a randomly generated QR UUID.</li>
          <li><b>Attendance events:</b> session ID, student ID, timestamp, source (manual scan or self check-in) and coarse GPS coordinates at the moment of check-in.</li>
          <li><b>Technical logs:</b> minimal server logs used for security and debugging.</li>
        </ul>
        ...
        <p>Processing is carried out under the legitimate interest of the university in maintaining accurate attendance records, and — for the storage of GPS coordinates — under the explicit consent of the student who chooses to use the self check-in feature.</p>

        <h2 className="text-xl font-semibold mt-8">5. Data isolation</h2>
        <p>Every record you create is tagged with your <b>owner_id</b>. Row-Level Security policies in the database prevent any lecturer from viewing another lecturer's students, sessions or attendance records.</p>

        <h2 className="text-xl font-semibold mt-8">6. Storage & retention</h2>
        <p>Data is hosted on Supabase infrastructure (TLS in transit, AES-256 at rest). Records are retained until the owning lecturer deletes them. Deleting a course, session or student cascades to the associated attendance records.</p>

        <h2 className="text-xl font-semibold mt-8">7. Sharing</h2>
        <p>We do not sell personal data. Data is shared only with the infrastructure provider hosting the Service (Supabase / Cloudflare) strictly to operate the Service.</p>

        <h2 className="text-xl font-semibold mt-8">8. Your rights</h2>
        <p>Students may contact the lecturer who uploaded their record to request access, correction or deletion. Lecturers may delete any record they own directly from the app.</p>
