...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "QRoll — Attendance Made Easy" },
      { property: "og:description", content: "Scan. Verify. Attend. Secure QR attendance for lectures, labs, and tutorials." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "QRoll — Attendance Made Easy" },
      { name: "twitter:description", content: "Scan. Verify. Attend. Secure QR attendance for universities." },
    ],
  }),
  component: Landing,
});
